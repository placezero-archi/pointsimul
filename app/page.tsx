...
export default function Home() {
  ...
  const handleCopyResults = async () => {
    ...
    const header = '통화\t최소 상품 금액\t계산값\t시스템 적립\t유저 출력\t손해율\t첫 포인트 사용까지 필요한 구매 횟수\t첫 포인트 사용까지 필요한 구매 금액\t전액 포인트 구매까지 필요한 금액';
        ...
        {results.length > 0 && (
          <div className="bg-white rounded-lg shadow p-6">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b-2 border-gray-200">
                    ...
                    <th className="px-4 py-3 text-right font-medium text-gray-700">
                      첫 포인트 사용까지<br/>필요한 구매 횟수
                    </th>
                    <th className="px-4 py-3 text-right font-medium text-gray-700">
                      첫 포인트 사용까지<br/>필요한 구매 금액
                    </th>
                    <th className="px-4 py-3 text-right font-medium text-gray-700">
                      전액 포인트 구매까지<br/>필요한 금액
                    </th>
                  </tr>
                </thead>
                <tbody>
            ...
            <div className="mt-6 p-4 bg-gray-50 rounded-lg text-sm text-gray-600">
              ...
              <p className="mb-2">
                <strong>첫 포인트 사용까지 필요한 구매 횟수:</strong> 최소 사용 단위 이상의 포인트를 모으기 위해 필요한 구매 횟수
              </p>
              <p className="mb-2">
                <strong>첫 포인트 사용까지 필요한 구매 금액:</strong> 최소 사용 단위 이상의 포인트를 모으기 위해 필요한 총 결제 금액
              </p>
              <p>
                <strong>전액 포인트 구매까지 필요한 금액:</strong> 최소 상품 금액을 100% 포인트로 구매하기 위해 필요한 총 PG 결제 금액
              </p>
            </div>
          </div>
        )}
